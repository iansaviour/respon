...
<div class="content-wrapper">
  ...
  <section class="content">
    <!-- table  -->
    <div class="row" id="panel-form-outbox" >
          ...
          <div class="box-body">
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="input-outbox-table" class="col-sm-2 control-label">Service</label>
                <div class="col-sm-10">
...
<?php
  ...
  if(isset($_GET['selService'])){
    ...
    $('#outbox').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "msg_outbox_act.php?t=outbox&id_service=<?php echo $id_service; ?>",
        "order": [[ 0, "desc" ]],
        "columnDefs": [
            {
                "targets": [ 0 ],
...
?>
  $("#btn-refresh-outbox").click(function(event) {
    window.location="msg_outbox.php" + <?php echo $penanda ?>;
  });
});
</script>